<div class="bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white w-64 min-h-screen py-8 px-6 flex flex-col shadow-2xl relative overflow-hidden">
    ...
    <nav class="relative flex-1 space-y-2">
        <a href="/" class="group flex items-center py-3.5 px-5 rounded-xl transition-all duration-300 hover:bg-white/10 hover:translate-x-1 {{ request()->is('dashboard') ? 'bg-gradient-to-r from-cyan-500/20 to-cyan-500/10 border-r-4 border-cyan-400' : '' }}">
        ...
        <a href="/instrucciones" class="group flex items-center py-3.5 px-5 rounded-xl transition-all duration-300 hover:bg-white/10 hover:translate-x-1 {{ request()->is('settings') ? 'bg-gradient-to-r from-rose-500/20 to-rose-500/10 border-r-4 border-rose-400' : '' }}">
        ...
        <a href="/presupuesto" class="group flex items-center py-3.5 px-5 rounded-xl transition-all duration-300 hover:bg-white/10 hover:translate-x-1 {{ request()->is('users') ? 'bg-gradient-to-r from-emerald-500/20 to-emerald-500/10 border-r-4 border-emerald-400' : '' }}">
        ...
        <a href="/lista-de-actividades" class="group flex items-center py-3.5 px-5 rounded-xl transition-all duration-300 hover:bg-white/10 hover:translate-x-1 {{ request()->is('products') ? 'bg-gradient-to-r from-amber-500/20 to-amber-500/10 border-r-4 border-amber-400' : '' }}">
        ...
        <a href="/calendario" class="group flex items-center py-3.5 px-5 rounded-xl transition-all duration-300 hover:bg-white/10 hover:translate-x-1 {{ request()->is('sales') ? 'bg-gradient-to-r from-fuchsia-500/20 to-fuchsia-500/10 border-r-4 border-fuchsia-400' : '' }}">
